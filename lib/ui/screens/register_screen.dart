...
import 'package:evently/ui/widgets/show_snack_bar.dart';
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> register({
    ...
    if (_formKey.currentState!.validate()) {
      final bool success = await context.read<AuthProviderService>().register(
        email: email,
        password: password,
        name: name,
      );
      ...
      if (mounted) {
        ...
        if (context.read<AuthProviderService>().errorMessage != null) {
          showSnackBar(
            context,
            context.read<AuthProviderService>().errorMessage!,
          );
        }
      }
    }
